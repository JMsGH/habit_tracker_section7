...
class PageFlipBuilderState extends State<PageFlipBuilder>
  ...
  // A "late" AnimationController can be initialized when it's declared
  // (rather than on initState())
...
class AnimatedPageFlipBuilder extends AnimatedWidget {
  ...
  // "as Animation<double>" is an explicit type cast to retrieve
  // our animation value. "listenable" doesn't have type information.
  ...
  Widget build(BuildContext context) {
    ...
    // To add depth, calculate tilt
    var tilt = (animation.value - 0.5).abs() - 0.5; // this value should be zero
